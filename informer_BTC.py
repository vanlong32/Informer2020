...
args.data_path = 'Binance_BTCUSDT_Full_7col.csv' 
...
# giả sử phần trên chỉ là đào tạo chưa có dự đoán 
# mình thấy exp.predict(setting, True) được gọi là mới chạy dự đoán. sau đó đượ
# lưu kết quả. 
...
setting = 'informer_custom_ftMS_sl96_ll48_pl15_dm1024_nh7_el2_dl1_df2048_atprob_fc5_ebtimeF_dtTrue_mxTrue_exp_0'
